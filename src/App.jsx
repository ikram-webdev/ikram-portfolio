  ...
  return (
    <div className="bg-white dark:bg-[#030014] text-gray-900 dark:text-white selection:bg-purple-500/30 min-h-screen overflow-x-hidden font-sans transition-colors duration-300 scroll-smooth">
          ...
          {isOpen && (
            ...
            >
              <div className="flex flex-col gap-8">
                ...
                <a
                  href="https://wa.me/923129699582"
                  className="flex items-center gap-3 text-green-500 font-bold text-xl"
                >
      ...
      <main className="relative z-10 pt-20">
          ...
          <motion.div initial="hidden" animate="visible" variants={fadeIn}>
            <div className="relative mx-auto w-40 h-40 mb-10">
              ...
              <img
                ...
                onError={(e) => {
                  e.target.src =
                    "https://ui-avatars.com/api/?name=Muhammad+Ikram&background=6366f1&color=fff&size=128";
                }}
              />
            </div>
            ...
            <p className="max-w-2xl mx-auto text-gray-500 dark:text-gray-400 text-lg md:text-xl mb-12">
              Transforming complex business logic into seamless user
              experiences. Specialized in building scalable full-stack Web
              Applications with high precision.
            </p>
            <div className="flex flex-wrap justify-center gap-5">
              <a
                href="#projects"
                className="px-10 py-4 bg-gray-900 dark:bg-white text-white dark:text-black font-black rounded-2xl hover:scale-105 transition-all shadow-xl shadow-purple-500/10"
              >
                View Work
              </a>
              <a
                href="https://github.com/ikram-webdev"
                target="_blank"
                className="px-10 py-4 bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-2xl font-black flex items-center gap-2 hover:bg-gray-200 dark:hover:bg-white/10 transition-all"
              >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
            {projects.map((p, i) => (
              <motion.div
                key={i}
                whileHover={{ y: -12 }}
                className="group relative bg-gray-50 dark:bg-white/[0.02] border border-gray-200 dark:border-white/10 rounded-[32px] overflow-hidden hover:border-purple-500/30 transition-all duration-500"
              >
                <div className="h-52 overflow-hidden relative">
                  <img
                    src={p.img}
                    alt={p.title}
                    className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700 opacity-80 dark:opacity-60 group-hover:opacity-100"
                  />
                ...
                <div className="p-8">
                  ...
                  <div className="flex flex-wrap gap-2 mb-8">
                    {p.tags.map((tag) => (
                      <span
                        key={tag}
                        className="text-[10px] font-black uppercase tracking-widest bg-purple-500/10 text-purple-600 dark:text-purple-400 border border-purple-500/20 px-3 py-1 rounded-lg "
                      >
                        {tag}
                      </span>
                    ))}
                  ...
                  >
                    <span>
                      {p.link === "#" ? "Offline" : "Live Preview"}
                    </span>
                    <ExternalLink
                      size={18}
                      className={p.link === "#" ? "opacity-30" : ""}
                    />
                  </a>
                </div>
              </motion.div>
        ...
        <section
          id="skills"
          className="max-w-7xl mx-auto py-32 px-6 border-t border-gray-200 dark:border-white/5"
        >
          <div className="grid md:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400 text-lg leading-relaxed mb-8">
                I focus on modern, performant technologies that provide the best
                user experience.
              </p>
            ...
            <div className="grid grid-cols-2 gap-6">
              {[
                ...
                {
                  label: "Tools",
                  val: "VS Code • Github • Postman • Vercel • Render",
                },
              ].map((s, i) => (
                <div
                  key={i}
                  className="p-6 bg-gray-50 dark:bg-white/[0.03] border border-gray-200 dark:border-white/5 rounded-3xl hover:bg-gray-100 dark:hover:bg-white/5 transition-colors"
                >
        ...
        <section id="contact" className="max-w-5xl mx-auto py-32 px-6">
          <div className="relative p-12 md:p-20 rounded-[48px] overflow-hidden text-center border border-gray-200 dark:border-white/10 shadow-2xl bg-gray-50 dark:bg-transparent">
            ...
            <div className="flex flex-col items-center gap-8">
              <button
                onClick={copyEmail}
                className="group flex items-center gap-4 bg-gray-900 dark:bg-white px-10 py-5 rounded-2xl text-white dark:text-black font-black hover:scale-105 transition-all shadow-2xl"
              >
                <Mail size={24} />{" "}
                {copied ? "Email Copied!" : "ikramkamboh818@gmail.com"}
              </button>
              <div className="flex flex-wrap justify-center gap-4 mt-4">
                <a
                  href="https://wa.me/923129699582"
                  target="_blank"
                  className="p-4 bg-green-500/10 text-green-600 rounded-2xl border border-green-500/20 hover:bg-green-500 hover:text-white transition-all"
                >
                  <FaWhatsapp size={24} />
                </a>
                <a
                  href="https://www.linkedin.com/in/muhammad-ikram-460663256"
                  target="_blank"
                  className="p-4 bg-blue-500/10 text-blue-600 rounded-2xl border border-blue-500/20 hover:bg-blue-500 hover:text-white transition-all"
                >
                  <Linkedin size={24} />
                </a>
                <a
                  href="https://www.fiverr.com/ikram_546"
                  target="_blank"
                  className="px-6 py-4 bg-gray-100 dark:bg-white/5 rounded-2xl border border-gray-200 dark:border-white/10 font-black italic hover:bg-gray-900 hover:text-white transition-all"
                >
                  Fiverr.
                </a>
              </div>
